  ...
  <html>
    ...
    <body>
      ...
      <div className="bottom">
        <div className="time">2022/02/22</div>
        <div className="logo">
          <img alt="icon" width="48px" height="48px" src="/favicon.png" />

          <svg height="32px" viewBox="0 0 95 20">
            <path
...
const OgImageApi = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  const markup = ReactDOM.renderToStaticMarkup(<Content post={getPost(id)} />);
